...
resource "local_file" "ansible_inventory" {
  content = templatefile("${path.module}/../../../../../ansible/inventory/prod/proxmox/observability-stack/inventory.tpl", {
    containers = {
  ...
  filename = "${path.module}/../../../../../ansible/inventory/prod/proxmox/observability-stack/inventory.ini"
}
